...
public class FavouriteRestaurantAdapter extends RecyclerView.Adapter<FavouriteRestaurantAdapter.ViewHolder> {
    Context context;
    List<Restaurant> restaurantList;

    public FavouriteRestaurantAdapter(Context context, List<Restaurant> restaurantList) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        holder.delivery_time.setText(restaurantList.get(position).getDelivery_time_min() + " - "
                + restaurantList.get(position).getDelivery_time_min() + " " + context.getString(R.string.min));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        TextView name, delivery_time, min_order_price, delivery_price, working_hours_tv, close_tv;
    ...
    private void removeItem(int position) {
        ...
        if (restaurantList.size() < 1) {
            FavoriteFragment.wishlist_empty_linear.setVisibility(View.VISIBLE);
        }
    }
}
